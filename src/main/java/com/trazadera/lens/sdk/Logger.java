...
/**
 * Logger provides a simple interface for logging messages within the Trazadera Lens Agent.
 * It is designed to be used for debugging and logging information in a thread-safe manner.
 * <p>
 * This interface should be implemented by the Trazadera Lens Agent, and it is safe to use
 * from any thread. The logs can be captured and displayed in the Trazadera Lens UI.
 * <p>
 ...
 * <p>
 * Using this logger, you can log messages at different levels:
 * <ul>
 *     <li><strong>debug</strong>: For detailed debugging information.</li>
 *     <li><strong>info</strong>: For general informational messages.</li>
 *     <li><strong>error</strong>: For error messages that indicate a problem.</li>
 *     <li><strong>error with Throwable</strong>: For logging exceptions along with a message.</li>
 * </ul>
 * The methods support variable arguments, allowing you to format messages with additional context.
 * The messages can be formatted using Java String placeholders
 * (e.g., "%s" for strings, "%d" for integers, "%f" for floating-point numbers, etc.).
 * <p/>
 * Example usage:
 * <pre>
...
public interface Logger {
    ...
    /**
     * Logs an error message along with a Throwable (exception) with the specified format and arguments.
